...
const repeatMyParam = () => {
    return axios.get('http://localhost:3000/repeat/lol')
...
// CODE HERE
const sendAQuery = () => {
    axios.get('http://localhost:3000/query-test?name=Jonathan')
    .then(({ data }) => console.log(data))
}

let queryButton = document.addEventListener('click', sendAQuery);
////////////////
//INTERMEDIATE//
////////////////
